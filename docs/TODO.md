...
- [x] Now-playing track titles on APK (ICY StreamTitle → dock; the bridge was calling a native method that doesn't exist, so every subscription failed silently)
