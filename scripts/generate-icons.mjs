...
/**
 * RadioScout app-icon artwork — glass music note with sparkle.
 * Full-bleed moss background keeps maskable + apple-touch icons safe under
 * OS cropping (key art sits inside the central ~66%).
 */

const MARK_PATHS = `
    <path d="M19.0283 2.07158C20.57 1.77535 22 2.95673 22 4.52666V16.5003C21.9998 17.0524 21.5521 17.5003 21 17.5003C20.4479 17.5003 20.0002 17.0524 20 16.5003V7.38408L11 9.11553V19.5003C10.9997 20.0524 10.5521 20.5003 10 20.5003C9.44787 20.5003 9.00025 20.0524 9 19.5003V6.47783C9.00003 5.03945 10.0211 3.80318 11.4336 3.53154L19.0283 2.07158Z" class="mark-note" fill="url(#note_body)" mask="url(#note_mask)"></path>
    <path d="M19.0283 2.07158C20.57 1.77535 22 2.95673 22 4.52666V16.5003C21.9998 17.0524 21.5521 17.5003 21 17.5003C20.4479 17.5003 20.0002 17.0524 20 16.5003V7.38408L11 9.11553V19.5003C10.9997 20.0524 10.5521 20.5003 10 20.5003C9.44787 20.5003 9.00025 20.0524 9 19.5003V6.47783C9.00003 5.03945 10.0211 3.80318 11.4336 3.53154L19.0283 2.07158Z" class="mark-note" fill="url(#note_body)" filter="url(#note_filter)" clip-path="url(#note_clip)"></path>
    <path d="M7.5 16.0005C9.433 16.0005 11 17.5675 11 19.5005C10.9998 21.4333 9.43285 23.0005 7.5 23.0005C5.56719 23.0004 4.00024 21.4332 4 19.5005C4 17.5675 5.56704 16.0005 7.5 16.0005ZM18.5 13.0005C20.433 13.0005 22 14.5675 22 16.5005C21.9998 18.4333 20.4328 20.0005 18.5 20.0005C16.5672 20.0004 15.0002 18.4332 15 16.5005C15 14.5675 16.567 13.0005 18.5 13.0005ZM5.57031 1.34131C5.9044 0.499973 7.09575 0.499914 7.42969 1.34131L8.60938 4.31494C8.62299 4.34909 8.65042 4.37555 8.68457 4.38916L11.6592 5.5708C12.5005 5.90483 12.5005 7.09515 11.6592 7.4292L8.68457 8.61084C8.65043 8.62444 8.623 8.65093 8.60938 8.68506L7.42969 11.6587C7.09575 12.5001 5.9044 12.5 5.57031 11.6587L4.38965 8.68506C4.37601 8.65096 4.34858 8.62443 4.31445 8.61084L1.34082 7.4292C0.49956 7.09515 0.49956 5.90485 1.34082 5.5708L4.31445 4.38916C4.3486 4.37556 4.37602 4.34907 4.38965 4.31494L5.57031 1.34131Z" fill="url(#note_sparkle)"></path>
    <path d="M18.5 13C20.433 13 22 14.567 22 16.5C22 18.433 20.433 20 18.5 20C16.567 20 15 18.433 15 16.5C15 14.567 16.567 13 18.5 13ZM18.5 13.75C16.9812 13.75 15.75 14.9812 15.75 16.5C15.75 18.0188 16.9812 19.25 18.5 19.25C20.0188 19.25 21.25 18.0188 21.25 16.5C21.25 14.9812 20.0188 13.75 18.5 13.75Z" fill="url(#note_light)"></path>
...
const MARK_DEFS = `
    <defs>
      ...
      <linearGradient id="note_body_dark" x1="15.5" y1="2.026" x2="15.5" y2="20.5" gradientUnits="userSpaceOnUse">
        ...
        <stop offset="1" stop-color="#c4c4ca"></stop>
      </linearGradient>
      <linearGradient id="note_sparkle" x1="11.355" y1=".71" x2="11.355" y2="23" gradientUnits="userSpaceOnUse">
        <stop stop-color="#E3E3E5" stop-opacity=".6"></stop>
        <stop offset="1" stop-color="#BBBBC0" stop-opacity=".6"></stop>
      </linearGradient>
      <linearGradient id="note_light" x1="0" y1="0" x2="0" y2="1">
        <stop stop-color="#fff"></stop>
        <stop offset="1" stop-color="#fff" stop-opacity="0"></stop>
      </linearGradient>
      <filter id="note_filter" x="-100%" y="-100%" width="400%" height="400%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse">
        <feGaussianBlur stdDeviation="2" x="0%" y="0%" width="100%" height="100%" in="SourceGraphic" edgeMode="none" result="blur"></feGaussianBlur>
      </filter>
      <clipPath id="note_clip">
        <path d="M7.5 16.0005C9.433 16.0005 11 17.5675 11 19.5005C10.9998 21.4333 9.43285 23.0005 7.5 23.0005C5.56719 23.0004 4.00024 21.4332 4 19.5005C4 17.5675 5.56704 16.0005 7.5 16.0005ZM18.5 13.0005C20.433 13.0005 22 14.5675 22 16.5005C21.9998 18.4333 20.4328 20.0005 18.5 20.0005C16.5672 20.0004 15.0002 18.4332 15 16.5005C15 14.5675 16.567 13.0005 18.5 13.0005ZM5.57031 1.34131C5.9044 0.499973 7.09575 0.499914 7.42969 1.34131L8.60938 4.31494C8.62299 4.34909 8.65042 4.37555 8.68457 4.38916L11.6592 5.5708C12.5005 5.90483 12.5005 7.09515 11.6592 7.4292L8.68457 8.61084C8.65043 8.62444 8.623 8.65093 8.60938 8.68506L7.42969 11.6587C7.09575 12.5001 5.9044 12.5 5.57031 11.6587L4.38965 8.68506C4.37601 8.65096 4.34858 8.62443 4.31445 8.61084L1.34082 7.4292C0.49956 7.09515 0.49956 5.90485 1.34082 5.5708L4.31445 4.38916C4.3486 4.37556 4.37602 4.34907 4.38965 4.31494L5.57031 1.34131Z" fill="url(#note_sparkle)"></path>
      </clipPath>
      <mask id="note_mask">
...
const MARK_STYLE = `
  <style>
    @media (prefers-color-scheme: dark) {
      .mark-note { fill: url(#note_body_dark); }
    }
  </style>`;
...
const svgApple = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  <title>radio-note</title>
...
async function generate() {
  ...
  const sizes = [
    { size: 512, path: "public/web-app-manifest-512x512.png", source: svg },
    { size: 192, path: "public/web-app-manifest-192x192.png", source: svg },
    { size: 180, path: "public/apple-touch-icon.png", source: svgApple },
    { size: 96, path: "public/favicon-96x96.png", source: svg },
  ];

  for (const { size, path, source } of sizes) {
    await sharp(Buffer.from(source)).resize(size, size).png().toFile(path);
    console.log(`✓ ${path} (${size}x${size})`);
  }

  // favicon.ico from 32 and 48 pngs
